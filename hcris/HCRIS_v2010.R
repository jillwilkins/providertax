...
hcris.vars = rbind(hcris.vars,c('net_mcaid_rev','S100000','00200','00100','numeric'))
...
hcris.vars = rbind(hcris.vars,c('dsh_from_mcaid','S100000','00500','00100','numeric'))
...
hcris.vars = rbind(hcris.vars, c('tot_uncomp_care_cost', 'S100000', '03000', '00100', 'numeric'))
