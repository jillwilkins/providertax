...
# add in my own columns
hcris.vars = rbind(hcris.vars,c('tot_sal','S300002','00100','00200','numeric'))
hcris.vars = rbind(hcris.vars,c('tot_sal_paid_hrs','S300002','00100','00600','numeric'))
hcris.vars = rbind(hcris.vars,c('sum_1426','S300001','02700','01000','numeric'))
hcris.vars = rbind(hcris.vars,c('cost_charge_ratio','S100000','00100','00100','numeric'))
hcris.vars = rbind(hcris.vars,c('net_medicaid_rev','S100000','00200','00100','numeric'))
hcris.vars = rbind(hcris.vars,c('get_dsh_supp','S100000','00300','00100','alpha'))
hcris.vars = rbind(hcris.vars,c('net_med_all_dsh','S100000','00400','00100','alpha'))
hcris.vars = rbind(hcris.vars,c('dsh_from_med','S100000','00500','00100','numeric'))
hcris.vars = rbind(hcris.vars,c('medicaid_charge','S100000','00600','00100','numeric'))
hcris.vars = rbind(hcris.vars,c('medicaid_cost','S100000','00700','00100','numeric'))
hcris.vars = rbind(hcris.vars,c('rev_cost_medicaid','S100000','00800','00100','numeric'))
